...
description: Guide proper git commit practices including commit granularity, frequency, and message quality. Use proactively when: (1) making multiple related code changes, (2) completing any logical unit of work, (3) before refactoring or starting new features, (4) after fixing bugs or issues, (5) after creating new files or modules, (6) after updating multiple files, (7) when working through a multi-step task or todo list, (8) after each completed todo item, (9) after breaking long lines or reformatting code, (10) after regenerating code from literate sources. Trigger phrases: 'created', 'updated', 'modified', 'fixed', 'added', 'completed', 'finished', 'done with', 'broke long lines', 'fixed lines', 'regenerated', 'tangled', 'all tasks complete', multiple files changed. Always commit early and often with focused, single-purpose commits rather than large combined commits. Activate this DURING work, not just at the end. (project, gitignored)
---
